...
<xsl:with-param name="node" select="ancestor-or-self::d:part[1]"/>
  ...
  <xsl:apply-templates mode="part.titlepage.recto.auto.mode" select="d:partinfo/d:mediaobject"/>
  <xsl:apply-templates mode="part.titlepage.recto.auto.mode" select="d:docinfo/d:mediaobject"/>
  <xsl:apply-templates mode="part.titlepage.recto.auto.mode" select="d:info/d:mediaobject"/>
...
<xsl:template match="d:mediaobject" mode="part.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="part.titlepage.recto.style">
<xsl:apply-templates select="." mode="part.titlepage.recto.mode"/>
</div>
</xsl:template>
...
<xsl:template name="topic.titlepage.recto">
  ...
  <xsl:apply-templates mode="topic.titlepage.recto.auto.mode" select="d:topicinfo/d:mediaobject"/>
  <xsl:apply-templates mode="topic.titlepage.recto.auto.mode" select="d:info/d:mediaobject"/>
...
<xsl:template match="d:mediaobject" mode="topic.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="topic.titlepage.recto.style">
<xsl:apply-templates select="." mode="topic.titlepage.recto.mode"/>
</div>
</xsl:template>
